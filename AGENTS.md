...
- **最新 stable**：`v1.6.11.11`（2026-07-23）
- **最新下载链接**：`https://github.com/Lau0x/halo-theme-joe-next/releases/download/v1.6.11.11/theme-Joe3-1.6.11.11.zip`
- **交接说明**：项目已从 Claude Code 移交 Codex 维护；`v1.6.11.11` 已通过 Halo 2.25.4 浏览器回归并发布。
...
| 版本       | 主题                                                                                      |
| ---------- | ----------------------------------------------------------------------------------------- |
| v1.6.11.11 | 精品分类图片回归修复（懒加载同步替换 src 与 srcset · 新增打包守卫）                       |
...
_Last updated: 2026-07-23 · at v1.6.11.11 · by Roy Leo / 咕咕_
